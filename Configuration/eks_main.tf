...
# Creating IAM role for Worker Nodes
...
resource "aws_iam_instance_profile" "worker" {
  ...
  name       = "my-eks-worker-profile"
  role       = aws_iam_role.worker.name
}

# VPC and Subnets (using existing resources)
data "aws_vpc" "main" {
  tags = {
    Name = "my-vpc"
  }
...
resource "aws_eks_cluster" "eks_cluster" {
  name     = "my-eks-cluster"
  role_arn = aws_iam_role.eks_cluster_role.arn   # ✅ fix
...
resource "aws_eks_node_group" "node_grp" {
  ...
  node_role_arn   = aws_iam_role.eks_node_role.arn   # ✅ fix
  subnet_ids      = [data.aws_subnet.subnet_1.id, data.aws_subnet.subnet_2.id]
